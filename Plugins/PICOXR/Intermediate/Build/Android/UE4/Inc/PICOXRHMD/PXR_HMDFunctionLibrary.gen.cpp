...
// End Cross Module References
	...
	static UEnum* EPerformanceSettingTypes_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PICOXRHMD_EPerformanceSettingTypes, Z_Construct_UPackage__Script_PICOXRHMD(), TEXT("EPerformanceSettingTypes"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPerformanceSettingTypes(EPerformanceSettingTypes_StaticEnum, TEXT("/Script/PICOXRHMD"), TEXT("EPerformanceSettingTypes"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PICOXRHMD_EPerformanceSettingTypes_Hash() { return 1767737648U; }
	UEnum* Z_Construct_UEnum_PICOXRHMD_EPerformanceSettingTypes()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PICOXRHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPerformanceSettingTypes"), 0, Get_Z_Construct_UEnum_PICOXRHMD_EPerformanceSettingTypes_Hash(), false);
#else
	...
	static UEnum* EPerfSettingsLevel_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PICOXRHMD_EPerfSettingsLevel, Z_Construct_UPackage__Script_PICOXRHMD(), TEXT("EPerfSettingsLevel"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPerfSettingsLevel(EPerfSettingsLevel_StaticEnum, TEXT("/Script/PICOXRHMD"), TEXT("EPerfSettingsLevel"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PICOXRHMD_EPerfSettingsLevel_Hash() { return 2036025910U; }
	UEnum* Z_Construct_UEnum_PICOXRHMD_EPerfSettingsLevel()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PICOXRHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPerfSettingsLevel"), 0, Get_Z_Construct_UEnum_PICOXRHMD_EPerfSettingsLevel_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EPICOXREyeType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PICOXRHMD_EPICOXREyeType, Z_Construct_UPackage__Script_PICOXRHMD(), TEXT("EPICOXREyeType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPICOXREyeType(EPICOXREyeType_StaticEnum, TEXT("/Script/PICOXRHMD"), TEXT("EPICOXREyeType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PICOXRHMD_EPICOXREyeType_Hash() { return 1132082876U; }
	UEnum* Z_Construct_UEnum_PICOXRHMD_EPICOXREyeType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PICOXRHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPICOXREyeType"), 0, Get_Z_Construct_UEnum_PICOXRHMD_EPICOXREyeType_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_PICOXRHMD_EPICOXRFoveationLevel_Hash() { return 418941994U; }
...
static struct FScriptStruct_PICOXRHMD_StaticRegisterNativesFPxrSensorState
{
	...
	DEFINE_FUNCTION(UPICOXRHMDFunctionLibrary::execPXR_DestroyExternalSurface)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		UPICOXRHMDFunctionLibrary::PXR_DestroyExternalSurface();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UPICOXRHMDFunctionLibrary::execPXR_SetExternalSurface)
	{
		P_GET_STRUCT(FVector,Z_Param_Translation);
		P_GET_STRUCT(FRotator,Z_Param_Rotation);
		P_GET_STRUCT(FVector2D,Z_Param_Size);
		P_GET_UBOOL(Z_Param_IsDRM);
		P_GET_ENUM(EPICOXRAndroidSurface3DType,Z_Param_Type);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UPICOXRHMDFunctionLibrary::PXR_SetExternalSurface(Z_Param_Translation,Z_Param_Rotation,Z_Param_Size,Z_Param_IsDRM,EPICOXRAndroidSurface3DType(Z_Param_Type));
		P_NATIVE_END;
	}
	...
	void UPICOXRHMDFunctionLibrary::StaticRegisterNativesUPICOXRHMDFunctionLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PXR_DestroyExternalSurface", &UPICOXRHMDFunctionLibrary::execPXR_DestroyExternalSurface },
			...
			{ "PXR_SetExternalSurface", &UPICOXRHMDFunctionLibrary::execPXR_SetExternalSurface },
	...
	struct Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
		{ "ModuleRelativePath", "Public/PXR_HMDFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_DestroyExternalSurface", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_OutRotation = { "OutRotation", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetBaseRotationAndBaseOffsetInMeters_Parms, OutRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_OutBaseOffsetInMeters = { "OutBaseOffsetInMeters", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetBaseRotationAndBaseOffsetInMeters_Parms, OutBaseOffsetInMeters), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_OutRotation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_OutBaseOffsetInMeters,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
		{ "ModuleRelativePath", "Public/PXR_HMDFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_GetBaseRotationAndBaseOffsetInMeters", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_GetBaseRotationAndBaseOffsetInMeters_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14C22401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetFoveationLevel_Statics::NewProp_Level = { "Level", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetFoveationLevel_Parms, Level), Z_Construct_UEnum_PICOXRHMD_EPICOXRFoveationLevel, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetFoveationLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetFoveationLevel_Statics::NewProp_Level_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetFoveationLevel_Statics::NewProp_Level,
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::NewProp_Battery = { "Battery", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetHmdBatteryLevel_Parms, Battery), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_GetHmdBatteryLevel_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::NewProp_Battery,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_GetHmdBatteryLevel", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_GetHmdBatteryLevel_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_SettingType_Underlying;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_SettingType;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_Level_Underlying;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_Level;
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_SettingType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_SettingType = { "SettingType", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetPerformanceLevel_Parms, SettingType), Z_Construct_UEnum_PICOXRHMD_EPerformanceSettingTypes, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_Level_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_Level = { "Level", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetPerformanceLevel_Parms, Level), Z_Construct_UEnum_PICOXRHMD_EPerfSettingsLevel, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_GetPerformanceLevel_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_SettingType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_SettingType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_Level_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_Level,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetPredictedDisplayTime_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_GetPredictedDisplayTime", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_GetPredictedDisplayTime_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_GetToDeltaSensorY_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
		{ "ModuleRelativePath", "Public/PXR_HMDFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_GetToDeltaSensorY", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_GetToDeltaSensorY_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType = { "CoordinateType", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SelectCoordinateSpace_Parms, CoordinateType), Z_Construct_UEnum_PICOXRHMD_EPICOXRCoordinateType, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType_MetaData)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_SelectCoordinateSpace_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_CoordinateType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_SelectCoordinateSpace", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_SelectCoordinateSpace_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetBaseRotationAndBaseOffsetInMeters_Parms, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_BaseOffsetInMeters = { "BaseOffsetInMeters", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetBaseRotationAndBaseOffsetInMeters_Parms, BaseOffsetInMeters), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_Options = { "Options", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetBaseRotationAndBaseOffsetInMeters_Parms, Options), Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_Rotation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_BaseOffsetInMeters,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::NewProp_Options,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
		{ "ModuleRelativePath", "Public/PXR_HMDFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_SetBaseRotationAndBaseOffsetInMeters", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetBaseRotationAndBaseOffsetInMeters_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics
	{
		struct PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms
		{
			FVector Translation;
			FRotator Rotation;
			FVector2D Size;
			bool IsDRM;
			EPICOXRAndroidSurface3DType Type;
			bool ReturnValue;
		};
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_Translation;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_Rotation;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_Size;
		static void NewProp_IsDRM_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsDRM;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Translation = { "Translation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms, Translation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Size = { "Size", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms, Size), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_IsDRM_SetBit(void* Obj)
	{
		((PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms*)Obj)->IsDRM = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_IsDRM = { "IsDRM", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_IsDRM_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Type_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms, Type), Z_Construct_UEnum_PICOXRHMD_EPICOXRAndroidSurface3DType, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Translation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Rotation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Size,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_IsDRM,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Type_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_Type,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
		{ "ModuleRelativePath", "Public/PXR_HMDFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_SetExternalSurface", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetExternalSurface_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics
	{
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_FovLeftInDegrees;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_FovRightInDegrees;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_FovUpInDegrees;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_FovDownInDegrees;
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_Eye_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_Eye = { "Eye", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms, Eye), Z_Construct_UEnum_PICOXRHMD_EPICOXREyeType, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovLeftInDegrees = { "FovLeftInDegrees", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms, FovLeftInDegrees), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovRightInDegrees = { "FovRightInDegrees", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms, FovRightInDegrees), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovUpInDegrees = { "FovUpInDegrees", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms, FovUpInDegrees), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovDownInDegrees = { "FovDownInDegrees", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms, FovDownInDegrees), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_Eye_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_Eye,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovLeftInDegrees,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovRightInDegrees,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovUpInDegrees,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_FovDownInDegrees,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_SetFieldOfView", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetFieldOfView_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetFoveatedRenderingMode_Parms, Mode), Z_Construct_UEnum_PICOXRHMD_EFoveationRenderingMode, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetFoveatedRenderingMode_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_Mode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_Mode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_SettingType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_SettingType = { "SettingType", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetPerformanceLevel_Parms, SettingType), Z_Construct_UEnum_PICOXRHMD_EPerformanceSettingTypes, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_Level_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_Level = { "Level", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PICOXRHMDFunctionLibrary_eventPXR_SetPerformanceLevel_Parms, Level), Z_Construct_UEnum_PICOXRHMD_EPerfSettingsLevel, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetPerformanceLevel_Parms), &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_SettingType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_SettingType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_Level_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_Level,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPICOXRHMDFunctionLibrary, nullptr, "PXR_SetPerformanceLevel", nullptr, nullptr, sizeof(PICOXRHMDFunctionLibrary_eventPXR_SetPerformanceLevel_Parms), Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPICOXRHMDFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_GetFocusState, "GetFocusState" }, // 1450725874
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_BoundaryTestNode, "PXR_BoundaryTestNode" }, // 3356196796
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_BoundaryTestPoint, "PXR_BoundaryTestPoint" }, // 3362225186
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DestroyExternalSurface, "PXR_DestroyExternalSurface" }, // 787646906
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_DoesSupportPositionalTracking, "PXR_DoesSupportPositionalTracking" }, // 364603573
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetAcceleration, "PXR_GetAcceleration" }, // 2275479288
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetAngularAcceleration, "PXR_GetAngularAcceleration" }, // 3725185002
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetAngularVelocity, "PXR_GetAngularVelocity" }, // 822728641
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBaseRotationAndBaseOffsetInMeters, "PXR_GetBaseRotationAndBaseOffsetInMeters" }, // 686705299
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBoundaryConfigured, "PXR_GetBoundaryConfigured" }, // 3381940998
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBoundaryDimensions, "PXR_GetBoundaryDimensions" }, // 2639609278
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBoundaryEnabled, "PXR_GetBoundaryEnabled" }, // 4119903778
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBoundaryGeometry, "PXR_GetBoundaryGeometry" }, // 3837842836
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetBoundaryVisible, "PXR_GetBoundaryVisible" }, // 1701215854
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetCPUAndGPULevels, "PXR_GetCPUAndGPULevels" }, // 1289593798
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetCurrentDisplayFrequency, "PXR_GetCurrentDisplayFrequency" }, // 4138413500
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetCurrentOrientation, "PXR_GetCurrentOrientation" }, // 3569260828
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetCurrentPosition, "PXR_GetCurrentPosition" }, // 4073637066
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetDeviceModel, "PXR_GetDeviceModel" }, // 1709695372
		...
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetEventManager, "PXR_GetEventManager" }, // 735934938
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetFieldOfView, "PXR_GetFieldOfView" }, // 2558869321
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetFoveationLevel, "PXR_GetFoveationLevel" }, // 2909116674
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHFov, "PXR_GetHFov" }, // 3167993641
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHmdBatteryLevel, "PXR_GetHmdBatteryLevel" }, // 3896821137
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetHMDWornState, "PXR_GetHMDWornState" }, // 639712151
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetIPD, "PXR_GetIPD" }, // 1828544182
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPerformanceLevel, "PXR_GetPerformanceLevel" }, // 2083858482
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedDisplayTime, "PXR_GetPredictedDisplayTime" }, // 3298803504
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetPredictedMainSensorState, "PXR_GetPredictedMainSensorState" }, // 1076530276
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetSystemDisplayFrequency, "PXR_GetSystemDisplayFrequency" }, // 1122464936
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetToDeltaSensorY, "PXR_GetToDeltaSensorY" }, // 4035724658
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetVelocity, "PXR_GetVelocity" }, // 2538959889
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_GetVFov, "PXR_GetVFov" }, // 3512351426
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_IPDChangedDelegates, "PXR_IPDChangedDelegates" }, // 1658614371
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_QueryDeviceAbilities, "PXR_QueryDeviceAbilities" }, // 3754206937
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_ResetHMDSensor, "PXR_ResetHMDSensor" }, // 1506431380
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SelectCoordinateSpace, "PXR_SelectCoordinateSpace" }, // 3334237067
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBaseRotationAndBaseOffsetInMeters, "PXR_SetBaseRotationAndBaseOffsetInMeters" }, // 2776623584
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetBoundaryVisible, "PXR_SetBoundaryVisible" }, // 2435759129
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetColorScaleAndOffset, "PXR_SetColorScaleAndOffset" }, // 2080998043
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetCPUAndGPULevels, "PXR_SetCPUAndGPULevels" }, // 3723201275
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExternalSurface, "PXR_SetExternalSurface" }, // 1516741966
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetExtraLatencyMode, "PXR_SetExtraLatencyMode" }, // 2442567122
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFieldOfView, "PXR_SetFieldOfView" }, // 4226261219
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveatedRenderingMode, "PXR_SetFoveatedRenderingMode" }, // 32181696
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveationLevel, "PXR_SetFoveationLevel" }, // 3869026639
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetFoveationParameter, "PXR_SetFoveationParameter" }, // 2318677886
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetLateLatchingEnable, "PXR_SetLateLatchingEnable" }, // 651547941
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetPerformanceLevel, "PXR_SetPerformanceLevel" }, // 2927992149
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetSeeThroughBackground, "PXR_SetSeeThroughBackground" }, // 1461877145
		...
		{ &Z_Construct_UFunction_UPICOXRHMDFunctionLibrary_PXR_SetSystemDisplayFrequency, "PXR_SetSystemDisplayFrequency" }, // 2310398488
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UPICOXRHMDFunctionLibrary, 3941461786);
