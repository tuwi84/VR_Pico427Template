...
// End Cross Module References
	...
	static UEnum* EPICOXRSharpeningEnhanceModeType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningEnhanceModeType, Z_Construct_UPackage__Script_PICOXRHMD(), TEXT("EPICOXRSharpeningEnhanceModeType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPICOXRSharpeningEnhanceModeType(EPICOXRSharpeningEnhanceModeType_StaticEnum, TEXT("/Script/PICOXRHMD"), TEXT("EPICOXRSharpeningEnhanceModeType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningEnhanceModeType_Hash() { return 2589860645U; }
	UEnum* Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningEnhanceModeType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PICOXRHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPICOXRSharpeningEnhanceModeType"), 0, Get_Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningEnhanceModeType_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EPICOXRSharpeningType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningType, Z_Construct_UPackage__Script_PICOXRHMD(), TEXT("EPICOXRSharpeningType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPICOXRSharpeningType(EPICOXRSharpeningType_StaticEnum, TEXT("/Script/PICOXRHMD"), TEXT("EPICOXRSharpeningType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningType_Hash() { return 370675895U; }
	UEnum* Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PICOXRHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPICOXRSharpeningType"), 0, Get_Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningType_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableSuperResolution_MetaData[];
#endif
		static void NewProp_bEnableSuperResolution_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableSuperResolution;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_SharpeningSetting_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SharpeningSetting_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_SharpeningSetting;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_SharpeningEnhanceMode_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SharpeningEnhanceMode_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_SharpeningEnhanceMode;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_bEnableSuperResolution_MetaData[] = {
		{ "Category", "Feature" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_bEnableSuperResolution = { "bEnableSuperResolution", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPICOXRSettings), &Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_bEnableSuperResolution_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_bEnableSuperResolution_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_bEnableSuperResolution_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting_MetaData[] = {
		{ "Category", "Feature" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting = { "SharpeningSetting", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPICOXRSettings, SharpeningSetting), Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningType, METADATA_PARAMS(Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode_MetaData[] = {
		{ "Category", "Feature" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode = { "SharpeningEnhanceMode", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPICOXRSettings, SharpeningEnhanceMode), Z_Construct_UEnum_PICOXRHMD_EPICOXRSharpeningEnhanceModeType, METADATA_PARAMS(Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPICOXRSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_bEnableSuperResolution,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningSetting,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPICOXRSettings_Statics::NewProp_SharpeningEnhanceMode,
	};
	...
	IMPLEMENT_CLASS(UPICOXRSettings, 3833007872);
